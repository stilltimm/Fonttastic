...
public class KeyboardView: UIView {
    ...
    public typealias ViewModel = KeyboardViewModel

    // MARK: - Internal Instance Methods

    public var design: ViewModel.Design { viewModel.design }
    public var keyboardType: KeyboardType { viewModel.config.keyboardType }
